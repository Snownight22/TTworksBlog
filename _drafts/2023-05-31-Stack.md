...
layout: post
title: 抽象数据类型(ADT)-栈
date:   2023-05-31 16:10:00 +0800　
categories: Algorithm
tags: C
topping: true
---

栈是另一种抽象数据类型，我们在前面文章（[用数组实现栈](https://snownight22.github.io/TTworksBlog/2022/12/29/Stack/)）中讲到了它的定义和一种通用栈实现，实际应用中栈内多数只存储一种数据类型。这里我们实现一种存储单一数据类型的栈。  
