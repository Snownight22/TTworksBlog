...
|:---------:|:-------:|:----------------:|
| ![支付宝转账二维码]({{ '/assets/imgs/ali_pay.png' | prepend:site.baseurl }}) | ![微信转账二维码]({{ '/assets/imgs/wechat_pay.png' | prepend:site.baseurl }})|

---
当然，地主家也可能没有余粮，您可以关注我的微信公众号：SnowNight22，也不失为一种赞助： |

![微信公众号]({{ '/assets/imgs/wechat_official_account.png' | prepend:site.baseurl }})
